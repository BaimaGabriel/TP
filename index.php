                    ...
                    if(empty($_POST['motdepass'])) {
                       ...
                       $mdp=$_SESSION['mot_de_pass'];
                          ...
                          if($nom==$_SESSION['nom'] && $mdp==$_SESSION['mot_de_pass'])
                            {
                              header("location:AccueilReceptioniste.php");
                            }
                             else
                            {
...
<p>vueillez renseignez vos informations de connexion cher receptioniste</p>   
        ...
        <input type="submit" class="btn" name="submit" value="Se connecter" style="background-color:purple;border-radius:10px;color:black;">
    </form><br><br>
<a href="indexA.php" style="background-color: #98C9E2; text-decoration:none;color:white;border-radius:10px;"><b>je suis administrateur</b></a><br><br>  
